document.addEventListener('DOMContentLoaded', () => {
    ...
    function filtrarResultados() {
      ...
      if (filtrados.length === 0) {
        ...
        // Si no hay resultados, mostramos mensaje (texto blanco por el CSS)
        ...
        filtrados.forEach(item => {
          ...
          // Creamos un ENLACE (<a>) que envuelve TODO (imagen + texto)
          ...
          // Texto (en un span para controlarlo mejor)
          const textoSpan = document.createElement("span");
          textoSpan.textContent = item.id;
  
          // Metemos imagen y texto DENTRO del enlace
          enlace.appendChild(img);
          enlace.appendChild(textoSpan);
          
          // Metemos el enlace en la lista de resultados
