...
,
    "muerdeme-camaleon!": {  
        ...
        sinopsis: `
             La historia sigue a Eisaku Yazawa, un estudiante de secundaria que es bajito, físicamente débil y un cobarde total.<br> 
             Sin embargo, tiene un sueño enorme y bastante peligroso:<br> 
             quiere convertirse en el líder bōsōzoku (pandillero motorizado) más legendario de todo Japón y gobernar a todos los matones.<br>
<br>
             Como en una pelea real no tiene ninguna oportunidad, Yazawa sobrevive puramente a base de suerte absurda, malentendidos y faroles épicos.<br> 
             Cada vez que se cruza con delincuentes reales y aterradores, alguna coincidencia loca (o accidentes donde él no hace nada)<br> 
             hace que parezca que Yazawa los derrotó con extrema brutalidad o que es un genio táctico.<br> 
             Gracias a esto, va construyendo poco a poco una reputación inmerecida como un tipo durísimo y sádico al que todas las pandillas empiezan a temer y respetar.
        `,
...
,
    "hareluya-boy": {  
        titulo: "Hareluya II Boy [Sub Español e Inglés] [20/25]",
...
,
    "haikara-san-ga-tooru-1978": {  
        titulo: "Haikara-san ga Tooru 1978 [Sub Español, Ruso e Inglés] [30/42]",
